...
export default Component.extend({
  ...
  keys: [
    ...
    { code: 'Minus', text: '-' },
    { code: 'Equal', text: '+' },
    { code: 'Backspace', text: 'Backspace', class: styles.backspace },
    { code: 'Tab', text: 'Tab', class: styles.tab },
    { code: 'KeyQ', text: 'Q' },
    { code: 'KeyW', text: 'W' },
    { code: 'KeyE', text: 'E' },
    { code: 'KeyR', text: 'R' },
    ...
    { code: 'Backslash', text: '\\', class: styles.backslash },
    { code: 'CapsLock', text: 'Caps Lock', class: styles.capslock },
    { code: 'KeyA', text: 'A' },
    { code: 'KeyS', text: 'S' },
    { code: 'KeyD', text: 'D' },
    { code: 'KeyF', text: 'F' },
    ...
    { code: 'Semicolon', text: ';' },
    { code: 'Quote', text: '\'' },
    { code: 'Enter', text: 'Enter', class: styles.enter },
    { code: 'ShiftLeft', text: 'Shift', class: styles.shiftLeft },
    { code: 'KeyZ', text: 'Z' },
    { code: 'KeyX', text: 'X' },
    { code: 'KeyC', text: 'C' },
    { code: 'KeyV', text: 'V' },
    ...
    { code: 'Period', text: '.' },
    { code: 'Slash', text: '/' },
    { code: 'ShiftRight', text: 'Shift', class: styles.shiftRight },
    { code: 'ControlLeft', text: 'Ctrl', class: styles.ctrlLeft },
    { code: 'MetaLeft', text: '🐧' },
    { code: 'AltLeft', text: 'Alt', class: styles.altLeft },
    { code: 'Space', text: '', class: styles.space },
    { code: 'AltRight', text: 'Alt', class: styles.altRight },
    { code: 'MetaRight', text: '🐧' },
    { code: 'ControlRight', text: 'Ctrl', class: styles.ctrlRight },
  ],
  promptedState: {},
  lastSymbol: '',
